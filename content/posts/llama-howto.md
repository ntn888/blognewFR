...
description: "How to run the Zephyr-7b-beta LLM model locally on your system"
date: 2023-11-14T00:27:00
draft: false
category: ["selfhosting"]
tags: ["opensource", "AI", "selfhosted", "llamav2"]
---

This article was written a while back. While the setup still works if you need a truly local, unconnected AI inference, I've moved to a third party inference provider [openrouter](https://openrouter.ai/), so you don't have to splurge on hardware. The usage costs are next to nothing, and it's all the AI under one roof!

Although I believe they have a chat interface, I just use the api and my own chat application. *chatbox* is a simple desktop app, but it was giving me network errors all the time. So I use the selfhosted (on localhost) [librechat](https://github.com/danny-avila/LibreChat). Do note the instructions to enable openrouter provider [here](https://www.librechat.ai/docs/configuration/librechat_yaml/ai_endpoints/openrouter).
