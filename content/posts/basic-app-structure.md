...
description: "Setup Makefeile based environment for the bl702 MCU development"
date: 2022-02-22T00:28:00
draft: false
category: ["bl702"]
...
One file may already be familiar to you: `compile_commands.json`. If not see [this post](/posts/dev-env) on how to setup a dev environment.
